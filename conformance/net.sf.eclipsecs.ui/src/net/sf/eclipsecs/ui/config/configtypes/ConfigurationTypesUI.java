...
public final class ConfigurationTypesUI {
     ...
     * @return the editor
     * @throws CheckstylePluginException if the filter editor could not be
     *             instantiated.
     */
     ...
     * 
     * @param configType the configuration type
     * @return the image representing the configuration type or
     *         <code>null</code> if no image is registered
     */
    public static Image getConfigurationTypeImage(IConfigurationType configType) {
        ...
        if (iconPath != null) {
            ImageDescriptor descriptor = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                    CheckstyleUIPlugin.PLUGIN_ID, iconPath);
