...
public class CheckConfigurationWorkingSetEditor {
        ...
        if (config != null) {
            ...
            try {
                ...
                CheckstyleUIPlugin.warningDialog(getShell(), NLS.bind(
                        Messages.errorCannotResolveCheckLocation, config.getLocation(), config
                                .getName()), e);
            }
        }
    }
    ...
    private void exportCheckstyleCheckConfig() {
        ...
        try {
            ...
            CheckstyleUIPlugin
                    .errorDialog(getShell(), Messages.msgErrorFailedExportConfig, e, true);
        }
    }
                ...
                case 3:
                    ...
                    if (mWorkingSet instanceof GlobalCheckConfigurationWorkingSet) {
                        ...
                        if (((GlobalCheckConfigurationWorkingSet) mWorkingSet)
                            ...
                            image = CheckstyleUIPluginImages
                                    .getImage(CheckstyleUIPluginImages.TICK_ICON);
                        }
                    }
                    break;
                default:
