...
public abstract class CheckstyleUIPluginImages {
    ...
    static {
        ...
        MARKER_INFO = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
                "icons/checkstyle_info.gif"); //$NON-NLS-1$
        HELP_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
                "icons/help.gif"); //$NON-NLS-1$
        CORRECTION_ADD = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
                "icons/add_correction.gif"); //$NON-NLS-1$
        CORRECTION_CHANGE = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                CheckstyleUIPlugin.PLUGIN_ID, "icons/correction_change.gif"); //$NON-NLS-1$
        CORRECTION_REMOVE = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                CheckstyleUIPlugin.PLUGIN_ID, "icons/remove_correction.gif"); //$NON-NLS-1$
        TICK_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
                "icons/tick.gif"); //$NON-NLS-1$

        FILTER_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
                "icons/filter_16.gif"); //$NON-NLS-1$
        LIST_VIEW_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
                "icons/listingView.gif"); //$NON-NLS-1$
        GRAPH_VIEW_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                CheckstyleUIPlugin.PLUGIN_ID, "icons/graphView.gif"); //$NON-NLS-1$
        EXPORT_REPORT_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                CheckstyleUIPlugin.PLUGIN_ID, "icons/exportReport.gif"); //$NON-NLS-1$

        MODULEGROUP_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                CheckstyleUIPlugin.PLUGIN_ID, "icons/modulegroup.gif"); //$NON-NLS-1$
        MODULEGROUP_TICKED_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                CheckstyleUIPlugin.PLUGIN_ID, "icons/modulegroup_used.gif"); //$NON-NLS-1$
        MODULE_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
                "icons/module.gif"); //$NON-NLS-1$
        MODULE_TICKED_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(
                CheckstyleUIPlugin.PLUGIN_ID, "icons/module_used.gif"); //$NON-NLS-1$

        REFRESH_ICON = CheckstyleUIPlugin.imageDescriptorFromPlugin(CheckstyleUIPlugin.PLUGIN_ID,
