...
public class CheckstyleMarkerFilterDialog extends TitleAreaDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        mLblSelectedWorkingSet.setLayoutData(new GridData(GridData.FILL_HORIZONTAL
    ...
    private void initWorkingSetLabel() {
        ...
        if (mSelectedWorkingSet == null) {
            mLblSelectedWorkingSet
                    .setText(Messages.CheckstyleMarkerFilterDialog_msgNoWorkingSetSelected);
        }
        else {
        ...
        public void widgetSelected(SelectionEvent e) {
            if (e.widget == mChkFilterEnabled || e.widget == mChkSeverityEnabled) {
                ...
                IWorkingSetSelectionDialog dialog = PlatformUI.getWorkbench()
                        .getWorkingSetManager().createWorkingSetSelectionDialog(getShell(), false);
