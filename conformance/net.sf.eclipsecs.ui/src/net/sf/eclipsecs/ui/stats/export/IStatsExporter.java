...
public interface IStatsExporter {
     ...
     * as a key.
     * 
     * @param props a map containing key-value pairs {String, Object}
     * @throws StatsExporterException if a properties does not have a valid type
     *             (for instance, the font size is a boolean)
     */
     ...
     *             document
     */
    void generate(Stats stats, List details, File outputFile) throws StatsExporterException;
