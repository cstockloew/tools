...
public class MultiselectionList extends ListSelect implements
	...
	public MultiselectionList(VaadinConfigurationController controller, MapConfigurationOption mapOption, ConfigOptionRegistry registry) {
...
//				}
					...
					//Set the error of the validators as error message of this list select.
					setComponentError(new UserError(e.getMessage()));
				}
				// Check the dependencies of all other configuration options after this configuration option was changed.
	...
	/**
	 * If the is valid method of the list select is valid and the configuration option is valid return true else false. 
	 */
