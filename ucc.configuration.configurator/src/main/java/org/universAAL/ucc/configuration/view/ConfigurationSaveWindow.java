...
/**
 * 
 * This is a special window to ask for extra information about the instance which should be saved.
 * 
...
public class ConfigurationSaveWindow extends Window {
	...
	public ConfigurationSaveWindow(final VaadinConfigurationController controller, List<ConfigurationOption> configOptions) {
				...
				try{
					if(!saveForm.isValid()){
						...
						try {
							...
							ConfigurationSaveWindow.this.getParent().addWindow(new YesNoDialog("File already exists", "Do you want to save anyway?", new YesNoDialog.Callback() {
