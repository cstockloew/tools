...
public class Sub_Profile extends ManagedIndividual {

	/** Class URI */
	public static final String MY_URI = "http://ontology.universAAL.org/Profile.owl#Sub-Profile";
	
	
	static {
		register(Sub_Profile.class);
    }
    ...
    public Sub_Profile(String uri) {
		super(uri);
    }

    protected Sub_Profile(String uriPrefix, int numProps) {
