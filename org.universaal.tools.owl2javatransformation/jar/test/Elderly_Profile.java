...
public class Elderly_Profile extends User_Profile {
	...
	static {
		register(Elderly_Profile.class);
    }
    
    public static Restriction getClassRestrictionsOnProperty(String propURI) {
		return User_Profile.getClassRestrictionsOnProperty(propURI);
    }
    ...
    public static String getRDFSLabel() {
		return "Elderly_Profile";
    }
    
    protected Elderly_Profile() {
		super();
    }

    public Elderly_Profile(String uri) {
		super(uri);
    }

    protected Elderly_Profile(String uriPrefix, int numProps) {
