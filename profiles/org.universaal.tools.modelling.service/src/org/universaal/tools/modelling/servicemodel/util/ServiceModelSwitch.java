...
public class ServiceModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ServiceModelPackage.SERVICE_INTERFACE: {
			...
			case ServiceModelPackage.SERVICE_OPERATION: {
			...
			case ServiceModelPackage.PARAMETER: {
			...
			case ServiceModelPackage.SERVICE_EFFECT: {
				ServiceEffect serviceEffect = (ServiceEffect)theEObject;
				T result = caseServiceEffect(serviceEffect);
				if (result == null) result = caseNamedElement(serviceEffect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceModelPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceModelPackage.PROPERTY_PATH: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Effect</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Effect</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceEffect(ServiceEffect object) {
		return null;
	}
