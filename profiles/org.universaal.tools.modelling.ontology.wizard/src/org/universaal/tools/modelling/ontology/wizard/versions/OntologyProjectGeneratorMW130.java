...
public class OntologyProjectGeneratorMW130 extends OntologyProjectGeneratorMW120 {

	@Override
	public int getMWVersionNumber() {
		return IOntologyProjectGenerator.VER_130;
	}

	static Dependency[] dependencies = new Dependency[] {
		/*dep("org.apache.felix", "org.osgi.core", "1.0.1"),
		dep("org.universAAL.middleware", "mw.data.serialization.osgi", "1.3.0"),
		dep("org.universAAL.middleware", "mw.data.representation.osgi", "1.3.0"),
		dep("org.universAAL.middleware", "mw.bus.model.osgi", "1.3.0"),
		dep("org.universAAL.middleware", "mw.container.xfaces.osgi", "1.3.0"),
		dep("org.universAAL.middleware", "mw.container.osgi","1.3.0" ),
		dep("org.universAAL.middleware", "mw.bus.service.osgi","1.3.0" ),
		dep("org.universAAL.middleware", "mw.bus.context.osgi", "1.3.0"),
		dep("org.universAAL.middleware", "mw.bus.ui.osgi", "1.3.0"),
		dep("org.universAAL.ontology", "ont.phWorld", "1.3.0"),
		dep("org.universAAL.ontology", "ont.profile", "1.3.0"),
