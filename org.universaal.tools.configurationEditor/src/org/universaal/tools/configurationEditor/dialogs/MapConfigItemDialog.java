...
public class MapConfigItemDialog extends TitleAreaDialog  {
	...
	public MapConfigItemDialog(Shell parentShell) {
		super(parentShell);
	...
	public void create() {
	 ...
	 protected Control createDialogArea(Composite parent) {
	   ...
	   //  The text fields will grow with the size of the dialog
	    ...
	    attrLabel.setText("Options:");
	    gridData = new GridData();
	    gridData.verticalAlignment = SWT.TOP;
	    attrLabel.setLayoutData(gridData);
	    
	    optionsList = new List(container, SWT.BORDER | SWT.SINGLE | SWT.V_SCROLL);
	    gridData = new GridData();
	    gridData.grabExcessHorizontalSpace = true;
	    gridData.horizontalAlignment = GridData.FILL;
	    optionsList.setLayoutData(gridData);
	    
	    Button addOptionButton = new Button(container, SWT.PUSH);
	    ...
	    addOptionButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				OptionDialog ad = new OptionDialog(getShell());
				ad.create();
				ad.open();
	
				if(ad.getReturnCode() == Window.OK){
					optionsList.add(ad.getAttribute());
				}
			}
	    ...
	    gridData = new GridData();
	    gridData.verticalAlignment = SWT.TOP;
	    addOptionButton.setLayoutData(gridData);
	  ...
	  protected Button createOkButton(Composite parent, int id, 
		...
		private void saveInput() {
			...
			for (String option : optionsList.getItems()) {
