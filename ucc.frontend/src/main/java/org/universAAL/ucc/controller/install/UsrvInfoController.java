...
public class UsrvInfoController implements Button.ClickListener {
	...
	win.getForm().getField(bundle.getString("name.label")).setValue(
		usrv.getName());
	win.getNameTxt().setReadOnly(true);
	win.getProvider().setValue(usrv.getProvider());
	win.getForm().getField(bundle.getString("provider.label")).setValue(
		usrv.getProvider());
	win.getProvider().setReadOnly(true);
	win.getForm().getField(bundle.getString("description.label")).setValue(
		usrv.getDescription());
	...
	win.getForm().getField(bundle.getString("version.label")).setValue(
		version);
