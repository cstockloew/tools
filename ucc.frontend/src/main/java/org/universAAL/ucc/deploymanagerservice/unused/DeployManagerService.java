package org.universAAL.ucc.deploymanagerservice.unused;
...
public interface DeployManagerService {
	 ...
	 */
	public void install(@WebParam(name = "sessionKey") String sessionKey, @WebParam(name = "usrvfile") String usrvfile);
	/**
	 * update a service as specified in the .usrv file
	 * @param sessionKey: the sessionKey for the interaction obtained when uCC registers with uStore 
	 * @param usrvfile: the link to download the .usrv file, serviceId from uStore is provided in .usrv file. 
	 */
	public void update(@WebParam(name = "sessionKey") String sessionKey, @WebParam(name = "usrvfile") String usrvfile);
	/**
	 * uninstall a service 
	 * @param sessionKey: the sessionKey for the interaction obtained when uCC registers with uStore 
	 ...
	 * @param sessionKey: the sessionKey for the interaction obtained when uCC registers with uStore 
	 * @param serviceId
	 * @return The list of application bundles with their version in the following template:
	 * <serviceUnits>
	 ...
	 * </serviceUnits>
	 */
	public String getInstalledUnitsForService(@WebParam(name = "sessionKey") String sessionKey, @WebParam(name = "serviceId") String serviceId);
	/**
	 * get the AAL space profile 
	 * @return The AAL space profile in the following template:
	 ...
	 * 
	 * @param sessionKey: the sessionKey for the interaction obtained when uCC registers with uStore 
	 * @return The user profile in the following template:
