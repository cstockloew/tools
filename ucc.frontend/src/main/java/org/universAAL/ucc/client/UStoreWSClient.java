package org.universAAL.ucc.client;

import javax.xml.namespace.QName;
import javax.xml.ws.Service;
import javax.xml.ws.soap.SOAPBinding;

public class UStoreWSClient {
	...
	private static UStoreWSClient ustoreClient;
	
	private UStoreWSClient() {
...
//		DeploymentManager dm = service.getPort(DeploymentManager.class);
	 ...
	 */
	public static UStoreWSClient getUStoreClientInstance() {
		if(ustoreClient == null) {
			ustoreClient = new UStoreWSClient();
		} 
		return ustoreClient;
	}
