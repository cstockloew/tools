...
public final class OnlineStoreManager_OnlineStoreManagerPort_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            java.lang.String _registerDeployManager__return = port.registerDeployManager(_registerDeployManager_userName, _registerDeployManager_password, _registerDeployManager_ipAddress, _registerDeployManager_port);
            System.out.println("registerDeployManager.result=" + _registerDeployManager__return);
