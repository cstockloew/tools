...
/*	// main method for testing
	public static void main(String[] args) {
		...
		n.children.get(1).getChild().addChild("link2child_1_1", new Node("child_1_1"));
		...
		n = new Node("root");
		frame.addMessage("","","single", n, new Date());
		
		n = new Node("root");
		n.addChild("a1", new Node("a1"));
		n.addChild("a5", new Node("a5"));
		n.addChild("a3", new Node("a3"));
		n.addChild(Edge.typeString, new Node(Edge.typeString));
		n.addChild(Edge.typeString, new Node(Edge.typeString));
		n.addChild("a3", new Node("a3"));
		n.addChild("a3", new Node("a3"));
		n.addChild("z2", new Node("z2"));
		n.addChild("z9", new Node("z9"));
		n.addChild("b", new Node("b"));
