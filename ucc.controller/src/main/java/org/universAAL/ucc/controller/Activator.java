...
public class Activator implements BundleActivator {
	...
	private void getManagers() {
		...
		if(aalManagers != null){
			//moduleContext.logDebug("[ucc.controller.Activator.getManagers] AALSpaceManagers found...", null, null);
			...
			if(aalManagers instanceof AALSpaceManager){
				...
				//moduleContext.logWarn("[ucc.controller.Activator.getManagers] No AALSpaceManagers found", null, null);
		...
		if(refs != null){
			...
			//moduleContext.logWarn("[ucc.controller.Activator.getManagers] No DeployManager found", null, null);
