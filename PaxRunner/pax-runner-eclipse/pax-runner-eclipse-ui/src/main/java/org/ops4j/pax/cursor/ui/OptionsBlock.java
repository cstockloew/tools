    ...
    extends CursorTabBlock
{
   ...
   // private final Button m_hotDeploymentButton;
    ...
    public OptionsBlock( final Composite parent, final int style )
    {
     ...
     //   m_hotDeploymentButton = new Button( optionsGroup, SWT.CHECK );
     //   m_hotDeploymentButton.addSelectionListener( updateNotifier );
     //   m_hotDeploymentButton.setText( "Hot deployment" );
...
//        m_springProfileButton.setText("spring");
    ...
    public void initializeFrom( final ILaunchConfiguration configuration )
    {
      ...
      //      m_hotDeploymentButton.setSelection( configuration.getAttribute( Attribute.HOT_DEPLOYMENT, false ) );
            // get log option
...
//                m_springProfileButton.setSelection( profiles.contains( "spring-dm" ) );                
    ...
    //    configuration.setAttribute( Attribute.HOT_DEPLOYMENT, m_hotDeploymentButton.getSelection() );
        // save log option
...
//        }
       ...
       //     arguments.add( "--hotDeployment=" + m_hotDeploymentButton.getSelection() );
