...
public interface OnConfigurationChangedListener {
	...
	/**
	 * 
	 * @param registry is the ConfigurationOptionRegistry from which you can get all configuration options.
	 * @param option is the configuration option which was modified.
	 */
