...
public class AAL_Space extends Profilable_Entity {

	/** Class URI */
	public static final String MY_URI = "http://ontology.universAAL.org/Profile.owl#AAL-Space";
	
	
	static {
		register(AAL_Space.class);
    }
    ...
    public AAL_Space(String uri) {
		super(uri);
    }

    protected AAL_Space(String uriPrefix, int numProps) {
