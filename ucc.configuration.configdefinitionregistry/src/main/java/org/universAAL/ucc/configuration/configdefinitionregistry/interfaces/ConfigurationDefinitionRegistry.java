...
/**
 * 
 * The implementations of the configuration definition interface could be used to register
 * configuration definitions so the bundles could be configured with the configurator.
 * 
