    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        private final static long serialVersionUID = 12343L;
        @XmlElementRefs({
            @XmlElementRef(name = "path", namespace = "http://www.venstar.de/uapp", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "url", namespace = "http://www.venstar.de/uapp", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "runtimeId", namespace = "http://www.venstar.de/uapp", type = JAXBElement.class, required = false)
        })
