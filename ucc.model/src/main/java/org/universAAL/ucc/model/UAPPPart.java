...
/**
 * An UAPPPart represents a single part of a uapp file.
 * It has a name, an appId, a uapplocation, a version, 
 * a description and consists a Part, a bundleId and bundleVersion.
 * 
 * @author merkle
 *
 */
...
public class UAPPPart {
	...
	public UAPPPart(String appId, String name, String location, int major, int minor, int micro, 
