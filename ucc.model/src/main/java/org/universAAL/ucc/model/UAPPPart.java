...
public class UAPPPart {
    ...
    public UAPPPart(String appId, String name, String location, int major,
	    int minor, int micro, String description, boolean multipart,
	    Part part, String bundleId, String bundleVersion) {
	this.appId = appId;
	this.name = name;
