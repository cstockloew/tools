...
public interface DataAccess {
	 ...
	 * @param file xml file to update
	 * @param id ID of the user
	 * @param subprofiles A list of updated Subprofiles
	 */
	public void updateUserData(String file, String id, HashMap<String, ArrayList<Subprofile>>subprofiles);
	
	/**
	 * Gets the Datafields of a XML instance to generate a view for userinterface
	 * @param file xml file, which is unmarshalled
	 ...
	 * @param file file where the user is persisted.
	 * @param instance the user as instance
	 ...
	 * @param file xml file in which to save
	 * @param ontologyInstnce the Userinstance for saving
	 ...
	 * @param profile the xml file with the ontology profile
