...
/**
 * Database operations on user account information and persistence of user preferences.
 * 
...
public interface UserAccountDB {
	 ...
	 * @param pref a instance of preference data
	 * @param filepath the property file for persisting the preferences
	 */
    public void saveStoreAccessData(Preferences pref, String filepath);
    
    /**
     * Gets the preferences data
     * @param file file where the current data is stored
